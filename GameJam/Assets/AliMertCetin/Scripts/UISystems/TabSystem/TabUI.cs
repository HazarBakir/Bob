    ...
    public class TabUI : GameUI
    {
        ...
        public override void Show()
        {
            ...
            uiGameObject.transform.XIVTween()
                ...
                {
                    isActive = true;
                    // BUG : Recursive tween call may cause issues. Null ref or StackOverflow exception
        ...
        public override void Hide()
        {
            ...
            // Recursive tween call may cause issues. Null ref or StackOverflow exception
            uiGameObject.transform.XIVTween()
